...
bundle_slugs=(
  ...
  "account-hierarchy-intelligence"
  "model-serving-byom"
  "governance-evidence"
)
...
bundle_names=(
  ...
  "pulse360-account-hierarchy-intelligence"
...
member_files=(
  ...
  "account-hierarchy-intelligence.members.txt"
...
run_orders=(
  ...
  "sql/databricks/account_hierarchy/00_create_schema.sql sql/databricks/account_hierarchy/10_m1_account_hierarchy_edge.sql sql/databricks/account_hierarchy/20_m1_account_group_rollup.sql sql/databricks/account_hierarchy/30_m1_account_hierarchy_activation.sql sql/databricks/account_hierarchy/40_m1_account_hierarchy_activation_export.sql sql/databricks/account_hierarchy/50_m1_account_group_rollup_export.sql sql/databricks/account_hierarchy/60_m1_account_hierarchy_edge_export.sql"

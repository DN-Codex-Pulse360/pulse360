...
[[ -f "$workspace/governance-evidence/sql/databricks/governance_evidence/10_governance_evidence_packet.sql" ]] \
  || fail "Databricks governance-evidence workspace is missing evidence packet SQL"
[[ -f "$workspace/governance-evidence/contracts/governance_evidence_packet.schema.json" ]] \

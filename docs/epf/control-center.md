...
| --- | --- | --- | --- |
| 1.1 | Explain business problem without technology | Pass | docs/epf/stage-1.1-business-context-framing.md |
| 1.2 | At least one critical constraint per category | Pass | docs/epf/stage-1.2-enterprise-constraint-mapping.md |
| 1.3 | Data flow between critical systems is explicit | Pass | docs/epf/stage-1.3-1.4-platform-landscape-and-option-assessment.md |
| 1.4 | Rejected options and tradeoffs captured | Pass | docs/epf/stage-1.3-1.4-platform-landscape-and-option-assessment.md |
| 1.5 | New architect can onboard from docs alone | Pass | docs/epf/stage-1.5-decision-capture-and-scope-commitment.md |

...
| 2.6 | Formal GO/Conditional GO/No-GO recorded | In Review | docs/readout/internal-solution-readout-dashboard-pack.md; docs/readout/customer-sanitized-readout-page.md |
